...
BEGIN
    SELECT COUNT(*) INTO n
    FROM Property WHERE owner_ID = oID;
    dbms_output.put_line('This owner owns ' || n || ' properties.');
    ...
    LOOP
        ...
        dbms_output.put_line('Total Ar: ' || p_row.total_area);
        dbms_output.put_line('Plinth Ar: ' || p_row.plinth_area);
